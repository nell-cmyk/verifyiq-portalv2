...
| T-02-01-02 | Spoofing               | `tests/support/auth-state.ts`         | mitigate    | Every staged or reused storage state opens a fresh browser context and must leave sign-in controls hidden before setup returns. Evidence: `tests/support/auth-state.ts:49-75`.                                                                                                                                                          | closed |
