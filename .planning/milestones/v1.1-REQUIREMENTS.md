# Requirements Archive: v1.1 Unified Portal Automation Runner

**Archived:** 2026-05-13 **Status:** SHIPPED

The active `.planning/REQUIREMENTS.md` file is removed after close; the next
milestone recreates it with fresh requirements.
